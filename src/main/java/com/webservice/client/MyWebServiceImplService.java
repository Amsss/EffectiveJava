...
public class MyWebServiceImplService
    ...
    /**
     * @param features Test list of {@link WebServiceFeature} to configure on the proxy.  Supported features not in the <code>features</code> parameter will have their default values.
     * @return returns MyWebServiceImpl
     */
    @WebEndpoint(name = "myWebServiceImplPort")
